          ...
          <div className="space-y-4 pt-5 font-semibold">
            ...
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-500 dark:text-gray-400">
                ...
                object. This information can be verified and trusted because it
                is digitally signed. JWTs can be signed using a secret (with the
            ...
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                ...
                completely separate program stack for each thread etc. Also,
                they would have to start a thread which while is not as
                expensive as starting a full process is still not exactly cheap
              </p>
            </details>
          </div>
        </div>
